 ...
 *
 * Catatan keamanan:
 * - File ini hanya memuat metadata/modul, bukan data pasien.
 * - PHI/PII dan rekam medis tidak boleh ditaruh di repository publik.
 * - Jika kelak ada database operasional, akses harus melalui backend
 *   terautentikasi/berotorisasi dan menerapkan audit log.
 */
window.KLASTER_CONFIG = Object.freeze([
  ...
  },
  {
    ...
    operationalModules: ['Jadwal', 'Skrining', 'Tindak Lanjut', 'Monev', 'Indikator', 'Evidence']
  },
  {
    id: 'klaster-3',
    code: 'K3',
    ...
    operationalModules: ['Skrining', 'Risiko', 'Tindak Lanjut', 'Monev', 'Indikator', 'Evidence']
  },
  {
    id: 'klaster-4',
    code: 'K4',
